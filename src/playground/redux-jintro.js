...
const jintroOne = store.dispatch(addJintro({title:'CPA Offer ABC', hits: 50, destinationUrl: 'https://google.com', campaignUrl: 'https://yahoo.com', createdAt: -21000}));
const jintroTwo = store.dispatch(addJintro({title:'CPA Offer XYZ', hits: 100, destinationUrl: 'https://facebook.com', campaignUrl: 'https://ebay.com', shortUrl: 'offer', createdAt: -1000}));

// store.dispatch(removeJintro({ id: jintroTwo.jintro.id }));
// store.dispatch(editJintro(jintroTwo.jintro.id, {shortUrl: 'clickbank' }));

// store.dispatch(setTextFilter('cpa'));
